(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "graphql-tag", "./schema/schema-to-template-context", "./operations/transform-document", "./utils/introspection-to-schema", "./types", "./debugging", "graphql", "graphql-tools"], factory);
    }
    ...
    exports.DocumentNode = graphql_1.DocumentNode;
