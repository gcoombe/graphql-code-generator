(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../types", "graphql", "graphql/language/kinds", "../utils/get-field-def", "../schema/resolve-type", "../debugging", "../schema/resolve-type-indicators"], factory);
    }
    ...
    const { FIELD, FRAGMENT_SPREAD, INLINE_FRAGMENT } = kinds_1.Kind;
    ...
    function buildSelectionSet(schema, rootObject, node) {
        return (node && node.selections ? node.selections : []).map((selectionNode) => {
